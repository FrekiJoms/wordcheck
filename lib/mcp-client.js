...
class MCPClient {
  ...
  /** Replace a specific paragraph by index — precise, avoids global phrase bleed */
  async replaceParagraph(filePath, paragraphIndex, newText) {
    return this.callTool("replace_paragraph", {
      filename: filePath,
