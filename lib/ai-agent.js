...
const MODEL_PRESETS = {
  "opencode-zen": [
    ...
    { id: "hy3-free", desc: "Hy3 Free", group: "Free" },
    { id: "big-pickle", desc: "Big Pickle (free)", group: "Free" },
    ...
    { id: "qwen3.7-plus", desc: "Qwen3.7 Plus", group: "Open" },
  ...
  "opencode-go": [
    { id: "mimo-v2.5", desc: "MiMo V2.5 (default)" },
    { id: "mimo-v2.5-pro", desc: "MiMo V2.5 Pro" },
    { id: "deepseek-v4-pro", desc: "DeepSeek V4 Pro" },
    { id: "deepseek-v4-flash", desc: "DeepSeek V4 Flash" },
    { id: "glm-5.3-flash", desc: "GLM 5.3 Flash" },
    { id: "glm-5.3", desc: "GLM 5.3" },
    { id: "kimi-k3", desc: "Kimi K3" },
    { id: "qwen3.8-flash", desc: "Qwen3.8 Flash" },
    { id: "qwen3.7-plus", desc: "Qwen3.7 Plus" },
    { id: "grok-4.6", desc: "Grok 4.6" },
    { id: "gpt-5.6-luna", desc: "GPT 5.6 Luna" },
    { id: "longcat-2.0", desc: "LongCat 2.0" },
    { id: "hy3", desc: "Hy3" },
    { id: "hy4-preview", desc: "Hy4 Preview" },
  ],
  openai: [
