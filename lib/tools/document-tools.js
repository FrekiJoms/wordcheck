...
async function executeDocumentTool(name, args, context) {
  const toolNames = new Set([
    "create_document", "open_document", "get_document_text", "get_paragraph",
    "get_document_info", "get_document_outline", "find_text_in_document",
    "list_documents", "copy_document", "convert_to_pdf", "format_document",
  ]);
