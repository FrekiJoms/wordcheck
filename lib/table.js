...
/** Pad string to target visible width (ANSI-safe) */
 ...
 * @param {Array<number>} opts.widths - Column widths (visible characters)
...
module.exports = { renderTable, renderPanel, BOX, visibleLen, padVisible };
