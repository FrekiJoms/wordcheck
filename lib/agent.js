...
class Agent {
  ...
  _modelGroup(modelId, providerId) {
    ...
    // Zen models — categorize
    const freeModels = [
      "mimo-v2.5-free", "hy3-free", "ling-3.0-flash-fin-free",
      "nemotron-3-ultra-free", "nemotron-3.5-lightning-free",
      "big-pickle", "muse-spark-1.2-contributor-free",
    ];
    if (freeModels.includes(modelId)) return "Free";
    if (modelId.startsWith("gpt-") || modelId.startsWith("claude-") ||
        modelId.startsWith("gemini-") || modelId.startsWith("grok-") ||
        modelId.startsWith("muse-spark-1.2")) return "Premium";
    return "Open";
  }
